...
const SEED: Item[] = [{"title": "Open project", "body": "app://projects/{id}", "status": "Active"}].map((x: any, i: number) => ({
  id: String(x.id ?? i + 1),
  title: x.title,
  body: x.body,
  status: x.status,
...
export default function Home() {
  const [items, setItems] = useLocalStorage<Item[]>("deeplinks-v1", SEED);
  ...
  return (
    <Shell title="Deep Links" subtitle="Map app routes to deep link URLs.">
